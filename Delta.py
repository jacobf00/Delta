...
class db:
    ...
    def setAngles(self,thetas:tuple):
        ...
        t1 = threading.Thread(target=self.servo1.setPosition,args=(theta0,))
        t1.start()
        t2 = threading.Thread(target=self.servo2.setPosition,args=(theta1,))
        t2.start()
        t3 = threading.Thread(target=self.servo3.setPosition,args=(theta2,))
        t3.start()
