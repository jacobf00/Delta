...
if __name__ == '__main__':
    ...
    surf = plot.scatter(xs=[x for x,y,z in points] ,ys=[y for x,y,z in points],zs=[z for x,y,z in points],alpha=.2)
    ...
    plane = plot.plot_surface(xx,yy,z,alpha=.6,color='orange')
